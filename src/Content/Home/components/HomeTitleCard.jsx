...
export default function HomeTitleCard({card}) {
  ...
  return (
    <Link
      className="magic-center gap-5 bg-[--highlight-color] hover:bg-[--highlight-hover-color] duration-300 h-[450px] p-3 rounded-2xl shadow-lg shadow-[--shadow-color] home-title-card transition-colors md:max-w-[430px]"
