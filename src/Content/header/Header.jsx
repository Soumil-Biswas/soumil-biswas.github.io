...
export default function Header() {
  ...
  return (
    <>
      ...
      <header className="flex justify-between items-center px-20 py-8 bg-[--background-color-offset] gap-4 print:hidden w-full fixed top-0 z-20 shadow-lg shadow-[--contrast-color]">
        {/* Logo and Navbar */}
